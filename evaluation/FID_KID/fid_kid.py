...
def _compute_statistics_of_path(path, model, batch_size, dims, cuda):
    if path.endswith('.npz'):
        ...
        files = list(path.glob('*.jpg')) + list(path.glob('*.png')) + list(path.glob('*.tiff'))
...
if __name__ == '__main__':
    ...
    # args.path = ['/home/disk2/Lynn/datasets/outputs-controlnet-whu', '/home/disk2/Lynn/datasets/s224cleaned_900_198/cyclegan/testB']
    args.batch_size = 1
    args.gpu = 1
