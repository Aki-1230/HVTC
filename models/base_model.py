...
class BaseModel(ABC):
    ...
    def get_current_metrics(self):
        """Return traning metrics. train.py will print out these metrics on console, and save them to a file"""
    ...
    def _measure_single_module(self, module, input_tensor, num_iter=100):
        """测量单个模块的推理时间"""
